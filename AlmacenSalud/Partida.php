...
<html>
	<head>
		...
		<script src="js/BusquedaPartida.js"></script> 
...
<body> <!-- Cuerpo -->
	<div class="contenedor"> 
		...
		<main class="cuerpoUp"> <!-- Contenedor -->
			<form action="SubirPartida.php" method="post" name="Alta">
            <article class="alta">
            	<table class="TablaP"> 
					<tr> 
					...
					<tr>
						<td> <input type="text" class="input_2" name="clave" placeholder="  Ingrese Clave..." autocomplete="off"> </td> <!-- Clave -->
