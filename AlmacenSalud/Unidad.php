...
<html>
	<head>
		...
		<script src="js/BusquedaUnidad.js"></script>  
...
<body> <!-- Cuerpo -->
	<div class="contenedor"> 
		...
		<main class="cuerpoUp"> <!-- Contenedor -->
			<form action="SubirUnidad.php" method="post" name="Alta">
            <article class="alta">
				<table class="TablaP"> 
					<tr> 
					...
					<tr>
						<td> <input type="text" class="input_1" name="unidad" placeholder="  Ingrese Unidad..." autocomplete="off"> </td> <!-- Nombre -->
					</tr>
				</table>
