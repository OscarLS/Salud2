...
<html>
	<head>
        ...
        <script src="MostrarOcultarPrograma.js"></script>   
...
<body> <!-- Cuerpo -->
	<div class="contenedor"> 
		<header class="cabecera"> <!-- Cabecera -->
			<h3>Licitacion Publica Internacional</h3>
            <div>
				<b> Programa </b>
		...
		<main class="cuerpoUp"> <!-- Contenedor -->
            ...
            <article class="alta-contrato">
            	<table class="TablaP"> 
					...
					<tr> 
                        <td>
                            <select class="input_1" name="licitacion" id="licitacion" autocomplete="off">  <!-- Financiamiento -->
                            <option value="----">  Seleccione  </option>
                            <?php
                                include_once('Conexion.php');
                                $sql="SELECT Licitacion FROM licitacion";
                                $result=mysqli_query($conn,$sql);
                                while ($mostrar=mysqli_fetch_array($result)) {
                                echo '<option value="'.$mostrar['Licitacion'].'">'.$mostrar['Licitacion'].'</option>';
                                }
                            ?>
                            </select>
                            <!-- <button type="button" class="BTA" onclick="document.location='Licitacion.php'">+</button> -->
                        </td>
						<td> <input type="text" class="input_1" name="contrato" id="contrato" placeholder="  Ingrese Contrato..." autocomplete="off"> </td> <!-- Contrato -->
					...
					<tr> 
                        ...
                        <td class="lD"> <p id="titulo"  style="display:none">Programa:</p> </td> <!-- Programa -->
					</tr>
					<tr> 
                        <td>
                        ...
                        <td>
                            <select class="input_1" name="programa" id="programa" style="display:none" autocomplete="off">  <!-- Programa -->
                            <option value="----">  Seleccione  </option>
                            <?php
                                include_once('Conexion.php');
            ...
            <article class="alta-contrato">
                ...
                <table class="TablaP"> 
					...
					<tr> 
                        ...
                        <td> <input type="text" class="input_1" name="indice" id="indice"  placeholder="  Ingrese Indice"  autocomplete="off"> </td> <!-- Cantidad -->
					</tr> 
				</table>
                <div class="botones">
