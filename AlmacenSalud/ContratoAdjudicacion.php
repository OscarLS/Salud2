...
<body>
    ...
    <div class="contenedor">
        ...
        <main class="cuerpoUp">
            ...
            <div>
                <button type="button" id="btnComprar" onclick="comprar();" class="btn btn-outline-primary">Comprar</button>
            ...
            <div class="modal-container" id="modal_container_Partida">
                <div class="modal">
                    <div class="contenedor">
                        ...
                        <main class="cuerpoUp">
                            <!-- Contenedor -->
                            <form action="subirPartidaModal.php" method="post" name="Alta">
                                <?php
            ...
            <div class="modal-container" id="modal_container_FF">
                <div class="modal">
                    <div class="contenedor">
                        ...
                        <main class="cuerpoUp">
                            <!-- Contenedor -->
                            <form action="SubirFinanciamientoModal.php" method="post" name="Alta">
                                <?php
            ...
            <div class="modal-container" id="modal_container_Programa">
                <div class="modal">
                    <div class="contenedor">
                        ...
                        <main class="cuerpoUp">
                            <!-- Contenedor -->
                            <form action="SubirProgramaModal.php" method="post" name="Alta">
                                <?php
            ...
            <div class="modal-container" id="modal_container_UnidadA">
                <div class="modal">
                    <div class="contenedor">
                        ...
                        <main class="cuerpoUp">
                            <!-- Contenedor -->
                            <form action="SubirCentroModal.php" method="post" name="Alta">
                                <?php
            ...
            <div class="modal-container" id="modal_container_Provedor">
                <div class="modal">
                    <div class="contenedor">
                        ...
                        <main class="cuerpoUp">
                            <!-- Contenedor -->
                            <form action="SubirProveedorModal.php" method="post" name="Alta">
                                <?php
            ...
            <div class="modal-container" id="modal_container_Producto">
                <div class="modal">
                    <div class="contenedor">
                        ...
                        <main class="cuerpoUp">
                            <!-- Contenedor -->
                            <form action="SubirProductoModal.php" method="post" name="Alta">
                                <?php
            ...
            <div class="modal-container" id="modal_container_Unidad">
                <div class="modal">
                    <div class="contenedor">
                        ...
                        <main class="cuerpoUp">
                            <!-- Contenedor -->
                            <form action="SubirUnidadModal.php" method="post" name="Alta">
                                <?php
            ...
            <div class="modal-container" id="modal_container_Categoria">
                <div class="modal">
                    <div class="contenedor">
                        ...
                        <main class="cuerpoUp">
                            <!-- Contenedor -->
                            <form action="SubirCategoriaModal.php" method="post" name="Alta">
                                <?php
